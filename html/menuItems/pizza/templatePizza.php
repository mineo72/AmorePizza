    ...
    <main class="containerItm">
      ...
      <div class="right-column">
        ...
        <div class="product-description">
          ...
          <br>
          <p id="description">The description for the item goes here. Honestly, it could be anything. Pizza, wings, sides, your soul, drinks, desserts, or maybe even a bagel! You can't survive without bagels! Try it, I dare you.</p>
        </div>
