<?php
	...
	if ($_SERVER["REQUEST_METHOD"] == "POST"){
		...
		header("Location: http://localhost:8080/html/menuitems/wings/templateWings.php?type=$itemType");
	}
	?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Wings Template | AmorayPizza</title>
  ...
  <body>
    ...
    <main class="containerItm">
      ...
      <form id="survey-form" method="post" action='templateWings.php?type=<?=$itemType?>'> <!--Change this to what it needs to be-->
      <!-- Right Column -->
      <div class="right-column">
        ...
        <div class="product-description">
          ...
          <br>
          <p>The best wings in a twelve meter radius!</p>
        </div>
          <fieldset>
            <!-- Sauce -->
            <label>Sauce
